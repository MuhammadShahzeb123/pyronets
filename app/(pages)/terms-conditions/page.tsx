    ...
    <>
      ...
      <Section>
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="glass rounded-xl p-8 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="glass rounded-xl p-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="glass rounded-xl p-8 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="glass rounded-xl p-8 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="glass rounded-xl p-8 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
          ...
          <div className="glass rounded-xl p-8 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
          ...
          <div className="glass rounded-xl p-8 animate-fade-in-up" style={{ animationDelay: '0.7s' }}>
            <h2 className="text-2xl font-bold text-foreground mb-4">8. Contact Information</h2>
            <p className="text-muted-foreground">
              If you have any questions about these Terms, please contact us at:
              <br />
              <strong className="text-foreground">Email:</strong> contact.pyronets@gmail.com
            </p>
          </div>
        </div>
      </Section>
