          ...
          <motion.div variants={itemVariants} className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              <motion.a
                ...
                className="w-10 h-10 glass rounded-lg flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-white/10 transition-all duration-300"
